...
import com.example.docenciamap2023.Interfaces.CheckCurso;
...
public class InicioAdapter extends RecyclerView.Adapter<InicioAdapter.ViewHolder> implements CheckCurso, View.OnClickListener{
    private List<Cursos> items;
    LayoutInflater inflater;
    ArrayList<Cursos> model;
    private View.OnClickListener listener;
    ArrayList<Cursos>  creaCursos;
    private Checkable habilitar;

    private CheckCurso observer;

    public InicioAdapter(Context context, ArrayList<Cursos> model){
    ...
    public InicioAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.inicio_lista_curso, parent, false);
        habilitar = (CheckBox) view.findViewById(R.id.habilitar);
        ...
        return new InicioAdapter.ViewHolder(view);
    }
    ////2
    ...
    @Override
    public void checkBoxChanged(boolean checkedStatus) {
