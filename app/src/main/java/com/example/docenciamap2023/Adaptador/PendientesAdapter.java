...
public class PendientesAdapter extends RecyclerView.Adapter<PendientesAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public PendientesAdapter(Context context, ArrayList<Cursos> model){
    ...
    @NonNull
    @Override
    public PendientesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.pendientes_lista_curso, parent, false);
        view.setOnClickListener(this);
        return new PendientesAdapter.ViewHolder(view);
    }
    ////2
    ...
    ////3
    @Override
    public void onBindViewHolder(@NonNull PendientesAdapter.ViewHolder holder, int position) {
